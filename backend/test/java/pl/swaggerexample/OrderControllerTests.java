...
public class OrderControllerTests {
    ...
    public void init() throws Exception {
        //for simplicity set the same ID, as the newly created user has
    ...
    private Order createOrder() throws Exception {
        ...
        List<Product> productList =
            mapper.readValue(getProducts, mapper.getTypeFactory().constructCollectionType(List.class, Product.class));
    ...
    public void getAllOrdersReturnOk() throws Exception {
        ...
        mockMvc.perform(get("/api/orders").with(authentication(MANAGER))).andDo(print())
               .andExpect(status().isOk())
    ...
    public void getAllOrdersWithoutPermissionReturnForbidden() throws Exception {
        mockMvc.perform(get("/api/orders").with(authentication(USER))).andDo(print()).andExpect(status().isForbidden());
    }
    ...
    public void getOrderWithoutPermissionReturnForbidden() throws Exception {
        mockMvc.perform(get("/api/orders/1").with(authentication(USER))).andDo(print()).andExpect(status().isForbidden());
    }
    ...
    public void getOrdersByOtherUserIdReturnForbidden() throws Exception {
        ...
        mockMvc.perform(get("/api/orders/buyer/2").with(authentication(USER))).andDo(print())
    ...
    public void deleteOrderWithAuthorizationReturnNoContent() throws Exception {
        ...
        mockMvc.perform(delete("/api/orders/{id}", order.getId()).with(authentication(MANAGER))).andDo(print())
               .andExpect(status().isNoContent());
    }

    @Test
    public void deleteOrderWithoutAuthorizationReturnForbidden() throws Exception {
        mockMvc.perform(delete("/api/orders/{id}", 1L).with(authentication(USER))).andDo(print())
               .andExpect(status().isForbidden());
    }

    @Test
    public void deleteOrderWithInvalidIdReturnNotFound() throws Exception {
        mockMvc.perform(delete("/api/orders/{id}", 999L).with(authentication(MANAGER))).andDo(print())
               .andExpect(status().isNotFound());
    }
}